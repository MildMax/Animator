...
/**
 * Create an Ellipse class that extends the AbstractShape abstract class.
 */
public class Ellipse extends AbstractShape {
  ...
  /**
   * Create a new instance of Ellipse.
   *
   ...
   */
  public Ellipse(String name, int layer, int initialVerticalRadius, int initialHorizontalRadius,
